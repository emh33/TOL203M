...
var translateXY = vec2(0.0, 0.0);

// Scale á x og y ás.
var scaleXY = vec2(1.0, 1.0);
...
window.onload = function init() {
    ...
    locTranslate =gl.getUniformLocation( program, "boxTranslate" );
...
function render() {
    ...
    gl.uniform2fv(locBox , flatten(translateXY));
    gl.uniform2fv(locScale, flatten(scaleXY));
